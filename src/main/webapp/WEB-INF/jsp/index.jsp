  ...
  <body class="app sidebar-mini rtl">
    ...
    <main class="app-content">
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="tile">
            <div class="tile-body" style="text-align: center;padding-top: 30px;padding-bottom: 30px;" id="maindiv">
              <%--这里插入bootstrap table--%>
              <img src="${pageContext.request.contextPath}/photo/01.jpg" width="80%" height="70%" >
            </div>
          </div>
        </div>
      </div>
    ...
    <script>
        ...
        var i = 1 ;
        function fn(){
            var img = document.getElementById("maindiv").getElementsByTagName("img")[0];
            i++;
            if(i==3){
                i=1;
            }
            img.src="${pageContext.request.contextPath}/photo/0"+i+".jpg";
        }
    </script>
  </body>
</html>